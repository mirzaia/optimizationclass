...
depth=1555; %kedalaman sumur (m) % DIGANTI
...
resthick=65; %reservoir thickness (m) % DIGANTI
reslength=1000; %reservoir length (m)% DIGANTI
Krock=0.026236; %thermal conductivity (W/mK) % DIGANTI
permeabil= 8.48734E-17; %permeability (m2)% DIGANTI
permeabilv= 8.48734E-18; %permeability vertikal (m2) % DIGANTI
poros= 0.089; %porosity batuan % DIGANTI
Lling = 3316.625; %Luas Lingkaran % DIGANTI

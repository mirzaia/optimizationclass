...
rng(10,'multFibonacci') % makes a plot with stops in Maine & Florida, and is reproducible
nStops = 45; % you can use any number, but the problem size scales as N^2
...
plot(x,y,'Color','green'); % draw the outside border
hold on
